        ...
        <div id="wb-head-in">
            <header>
                ...
                <nav role="navigation">
					...
					<ul>
						<li id="gcwu-gcnb1"><a href="#">Accueil</a></li>
						<li id="gcwu-gcnb2"><a href="#">Index A-Z</a></li>
						<li id="gcwu-gcnb3"><a href="#">Plan du site</a></li>
						...
						<li id="gcwu-gcnb6"><a href="#">monÉquipe</a></li>
						...
						<li id="gcwu-gcnb-lang"><a href="javascript:form_submit()" lang="fr">English</a></li>
                            ...
                            <div id="gcwu-gcnb-fip">
                                <div id="gcwu-sig">
                                    <div id="gcwu-sig-in">
                                        <object data="<?php echo $site_url;?>mod/gc_theme/views/default/gc_theme/dist/theme-gcwu-intranet/images/sig-static-fra.svg" 
                                                role="img" 
                                                tabindex="-1" aria-label="Gouvernment du Canada" type="image/svg+xml" 
                                                width="217" height="24">
                                            <div id="gcwu-sig-fra" title="Gouvernment du Canada"><img 
                                                    src="<?php echo $site_url;?>mod/gc_theme/views/default/gc_theme/dist/theme-gcwu-intranet/images/sig-fra.png" width="215" 
